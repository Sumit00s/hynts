...
export const revalidate = 86400; // ISR: revalidate every 24 hours (24 * 60 * 60 seconds)
...
export default async function FeaturedExperiences() {
  try {
    ...
    if (error) {
      console.error("❌ Error fetching featured interviews:", error.message);
      return null;
    }

    const interviews = data || [];

    // If no interviews found, return null
