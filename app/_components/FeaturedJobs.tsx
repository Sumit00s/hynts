...
export const revalidate = 43200; // ISR: revalidate every 12 hours (12 * 60 * 60 seconds)
...
export default async function FeaturedJobs() {
  try {
    ...
    const { data, error } = await supabase
      ...
      .limit(6); // Only get 6 featured jobs

    const FEATURED_JOBS = (data as unknown as Job[]) || [];
